  ...
  <div class="modal fade" id="formulario-actualizar-cliente" style="color: aliceblue" ; tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content modals">
        ...
        <div class="modal-body">
          <input class="form-control ActualizarCliente" type="text" id="primerNombre-nuevo" value="" placeholder="Primer Nombre">
          <br>
          <input class="form-control ActualizarCliente" type="text" id="primeroApellido-nuevo" placeholder="Primer Apellido" value="">
          <br>
          <input class="form-control ActualizarCliente" type="text" id="pais-nuevo" placeholder="Escriba su País de Origen" value="">
          <br>
          <textarea class="form-control ActualizarCliente" style="width:-moz-available" id="direccion-nuevo" name="Dirección" placeholder="Escriba aquí la Dirección"
          ...
          <div class="form-row align-items-center">
            <div class="input-group">
              <div class="input-group-prepend" style="height: 40px">
                ...
                <input type="text" id="correo-nuevo-cliente" class="form-control ActualizarCliente" placeholder="Escriba el correo electrónico"
          ...
          <div>
            <input type="password" id="ClaveCliente-nueva" class="form-control ActualizarCliente" placeholder="Escriba una contraseña segura"
              style="width:-moz-available" value="">
            <div class="valid-feedback" style="text-align:right">Ok</div>
            <div class="invalid-feedback" style="text-align:right; margin-bottom:9px">
          ...
          <br>
          <div>
            <input type="password" value="" id="ConfirmacionCliente-nueva" class="form-control ActualizarCliente" placeholder="Confirme su Contraseña"
              style="width:-moz-available; margin-left:auto">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
          <button id="btn-guardar" type="button" class="btn btn-primary" onclick="validarClienteNuevo()">Guardar Cambios</button>
        </div>
      </div>
    </div>
  </div>
